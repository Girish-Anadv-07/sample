...
parser.add_argument("-c", "--CAPSIZE",default=2000, help="stop traversing after growing equivalence class to this size.", type=int)
...
def clingo_caller(g):
    ...
    c = rasl_msl(g,capsize=args.CAPSIZE,urate=min(30,(3*len(g)+1)), pnum=args.PNUM)
